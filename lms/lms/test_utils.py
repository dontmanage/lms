...
class TestUtils(unittest.TestCase):
	...
	def test_evaluation_details(self):
		...
		dontmanage.db.delete("LMS Certificate Evaluation", {"course": course.name})
		dontmanage.db.delete("LMS Course", course.name)
		dontmanage.db.delete("User", user.name)


def create_evaluation(user, course, date, rating, status):
	evaluation = dontmanage.get_doc(
		{
