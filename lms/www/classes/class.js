...
const make_live_class_form = (e) => {
	this.field_group = new dontmanage.ui.FieldGroup({
		fields: [
			{
	...
	$("#live-class-form .dontmanage-control").removeClass("hide-control");
};
...
const make_add_students_section = () => {
	...
	$(".add-students .dontmanage-control").removeClass("hide-control");
};
